...
const s = StyleSheet.create({
  ...
  secondary: { backgroundColor: Colors.white, borderWidth: StyleSheet.hairlineWidth, borderColor: Colors.border },
  ghost: { backgroundColor: 'transparent' },
  danger: { backgroundColor: Colors.dangerLight, borderWidth: StyleSheet.hairlineWidth, borderColor: Colors.danger },
